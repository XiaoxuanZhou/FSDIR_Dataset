...
- 数据集已在 [Zenodo Part1](https://zenodo.org/records/17294296) [Zenodo Part2](https://zenodo.org/records/17213990) 或 [百度网盘](https://pan.baidu.com/s/11fGqpjKCtvAi3j83nN2hsw)提取码:DIRD. 长期归档，并提供 DOI 供引用。
---
## 📂 数据内容
数据集结构如下：
```bash
